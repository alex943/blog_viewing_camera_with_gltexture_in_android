...
public class GLES20Activity extends Activity {
    ...
    private BaseGLRender mGlRender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (detectOpenGLES20()) {
            ...
            //mGLSurfaceView.setRenderer(new GLES20BasicRenderer(this));
//            mGLSurfaceView.setRenderer(new GLES20PointOrTriangleRenderer(this));
            mGLSurfaceView.setRenderer(new GLES20TextureRenderer(this));
        } else {
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CAMERA: {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    mGlRender.onSurfaceCameraPermitted();
                } else {
                    finish();
                }
            }
